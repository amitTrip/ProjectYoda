...
console.log("CPE Detail List 1");

angular.module("codeProject").register.controller('CPEDetailListController', ['$routeParams', '$location', 'ajaxService', 'dataGridService', 'alertService',
